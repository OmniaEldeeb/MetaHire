      ...
      switch (name) {
        ...
        case "ApplicationUpdated":
          ...
          toast({
            ...
            // application.submitted is company-facing (owner + HR) — always open
            // the company view; HR members are candidate-role accounts.
            href:
              name === "application.submitted" || role === "company"
